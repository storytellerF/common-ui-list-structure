...
class RepoComposite2 extends CommonRoomDatabase<Repo, RepoRemoteKey, RepoDatabase> {
    public RepoComposite2(@NonNull RepoDatabase database) {
        super(database);
    }
    ...
    public Object insertAllData(@NonNull List<? extends Repo> repos, @NonNull Continuation<? super Unit> $completion) {
        getDatabase().reposDao().insertAll((List<Repo>) repos, $completion);
        return null;
    }
