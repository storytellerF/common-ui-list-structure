...
echo -e "\033[106m build giant-explorer-plugin-core \033[0m"
cd common-ui-list-structure
bash gradlew app:giant-explorer-plugin-core:build

echo
echo -e "\033[106m build yue \033[0m"
...
echo
echo -e "\033[106m build li \033[0m"
cd ../li
bash gradlew build
if [ $? -ne 0 ]; then
...
echo
echo -e "\033[1;106m build yue-html \033[0m"
cd ../yue-html
bash dispatch.sh
if [ $? -ne 0 ]; then
